 ...
 * @author Hoa Le
 */
public class QLKhoSachSua extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cboTheLoai.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "sách giáo khoa", "truyện thiếu nhi", "khám phá", "tiểu thuyết", " " }));
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cboTheLoai, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel9))
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtGiaTien, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel11))
                .addContainerGap())
        );
    ...
    private void btnSachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSachActionPerformed
        QLKhoSachSua qLKhoSach = new QLKhoSachSua();
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        if (txtMaSach.getText().isEmpty() || txtTieuDeSach.getText().isEmpty() || txtTenTacGia.getText().isEmpty() || txtNhaXuatBan.getText().isEmpty() || txtNamXuatBan.getText().isEmpty() || cboTheLoai.getSelectedItem() == null || txtSoLuong.getText().isEmpty() || txtGiaTien.getText().isEmpty()) {
            ...
            try {
                ...
                connect.updateSach(txtMaSach.getText(), txtTieuDeSach.getText(), txtTenTacGia.getText(), txtNhaXuatBan.getText(), Integer.parseInt(txtNamXuatBan.getText()), cboTheLoai.getSelectedItem().toString(), Integer.parseInt(txtSoLuong.getText()), Integer.parseInt(txtGiaTien.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLKhoSachSua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QLKhoSachSua().setVisible(true);
            }
        });
    }
