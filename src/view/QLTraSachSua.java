...
import static view.QLTraSachThem.tinhKhoangCachNgay;

/**
 *
 * @author Hoa Le
 */
public class QLTraSachSua extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Sửa thông tin phiếu trả");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnPhat, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        if (txtMaTra.getText().isEmpty() || cboMaMuon.getSelectedItem() == null || txtNgayTraThuc.getText().isEmpty() || txtTinhTrangTra.getText().isEmpty() || txtKhoanPhat.getText().isEmpty()) {
        JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ thông tin");
    } else {
        // Kiểm tra định dạng ngày trả thực
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        dateFormat.setLenient(false);

        try {
            dateFormat.parse(txtNgayTraThuc.getText());
        ...
        try {
            ...
            int khoanThu = Integer.parseInt(txtKhoanPhat.getText());
            String ghiChu = txtGhiChu.getText();

            Connect connect = new Connect();
            connect.updateTraSach(maTra, maMuon, ngayTraThuc, tinhTrangTra, khoanThu, ghiChu);
            JOptionPane.showMessageDialog(this, "Thông tin trả sách đã được cập nhật thành công");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLTraSachSua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QLTraSachSua().setVisible(true);
            }
        });
    }
    ...
    private void calculateKhoanThuAndGhiChu() {
    try {
