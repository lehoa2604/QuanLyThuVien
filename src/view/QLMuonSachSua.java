 ...
 * @author Hoa Le
 */
public class QLMuonSachSua extends javax.swing.JFrame {

    /**
     * Creates new form QLKhoSach
     */
    public QLMuonSachSua() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Sửa thông tin phiếu mượn");
    ...
    private void cboMaSachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboMaSachActionPerformed
        try {
            ...
            Logger.getLogger(QLMuonSachSua.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        String maDG = cboMaDocGia.getSelectedItem().toString();
        String maNV = cboMaNhanVien.getSelectedItem().toString();
        String ngayMuon = txtNgayMuon.getText();
        String ngayHenTra = txtNgayTra.getText();
        String tinhTrangMuon = txtTinhTrangMuon.getText();

        // Kiểm tra và định dạng lại chuỗi ngày mượn và ngày trả
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        dateFormat.setLenient(false);

        try {
            dateFormat.parse(ngayMuon);
            dateFormat.parse(ngayHenTra);
        } catch (ParseException ex) {
            // Hiển thị thông báo khi ngày không đúng định dạng
            JOptionPane.showMessageDialog(null, "Ngày phải có định dạng yyyy-MM-dd", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return; // Dừng thực hiện và thoát khỏi phương thức
        }

        // Tiếp tục xử lý khi ngày đúng định dạng
        connect.updateMuonSach(maMuon, maSach, maDG, maNV, ngayMuon, ngayHenTra, tinhTrangMuon);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLMuonSachSua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QLMuonSachSua().setVisible(true);
            }
        });
    }
    ...
    //lấy danh sách dữ liệu từ cột trong bảng cụ thể nào đó từ csdl//phương thức trả về danh sách chứa các giá trị từ cột đã chỉ định.
...
// qLDocGiaSua.setValues(maMuon, maSach, maDG, maNV, ngayMuon, ngayHenTra, tinhTrangMuon);
