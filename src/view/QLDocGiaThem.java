 ...
 * @author Hoa Le
 */
public class QLDocGiaThem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Thêm độc giả mới");
    ...
    private void btnSachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSachActionPerformed
       QLDocGiaThem qLKhoSach = new QLDocGiaThem();
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        if(txtMaDocGia.getText().isEmpty() || txtTenDocGia.getText().isEmpty() || txtLop.getText().isEmpty() || txtTuoi.getText().isEmpty() || txtDiaChi.getText().isEmpty() || txtSDT.getText().isEmpty() || txtEmail.getText().isEmpty()){
            ...
            try {
                ...
                connect.insertDocGia(txtMaDocGia.getText(), txtTenDocGia.getText(), txtLop.getText(), Integer.parseInt(txtTuoi.getText()), txtDiaChi.getText(), Integer.parseInt(txtSDT.getText()), txtEmail.getText());
               ...
               JOptionPane.showMessageDialog(this, "Trùng mã độc giả. Vui lòng nhập lại mã độc giả!!");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLDocGiaThem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QLDocGiaThem().setVisible(true);
            }
        });
    }
